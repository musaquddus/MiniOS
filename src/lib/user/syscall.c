...
int cache_hitrate() { return syscall0(SYS_CACHE_HR); }

void cache_reset() { syscall0(SYS_CACHE_RESET); }

int get_block_reads() { return syscall0(SYS_BLK_RD); }

int get_block_writes() { return syscall0(SYS_BLK_WR); }