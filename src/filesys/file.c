...
bool file_is_dir(struct file* file) { return inode_is_dir(file->inode); }

int get_inum(struct file* file) { return inode_get_inumber(file->inode); }

struct inode* get_inode(struct file* file) {
  return file->inode;
}
